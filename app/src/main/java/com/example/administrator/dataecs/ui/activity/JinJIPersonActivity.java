...
public class JinJIPersonActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jin_ji_new_lay);
    ...
    private void intData() {
        ...
        footLay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(JinJIPersonActivity.this, JinJIAddInfoActivity.class);
